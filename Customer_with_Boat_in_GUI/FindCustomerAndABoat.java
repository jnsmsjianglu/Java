...
public class FindCustomerAndABoat extends JFrame implements ActionListener  
{ 
	...
	{   
		...
		JPanel uoLowerPanel = new JPanel(new FlowLayout());
		...
		this.setTitle("Find A Customer and A Boat");
